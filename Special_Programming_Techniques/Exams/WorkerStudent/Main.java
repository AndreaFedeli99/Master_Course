...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Student.average() -> " + st.average());
        ...
        ws = Factory.getInstance(new Student(3, new String[]{"TSP"}, 29.7), new Worker(7, 2000));
        System.out.println("Student.studentId() -> " + ws.studentId());
        System.out.println("Student.curricula() -> " + Arrays.toString(ws.curricula()));
        System.out.println("Student.average() -> " + ws.average());
        System.out.println("Student.workerId() -> " + ws.workerId());
